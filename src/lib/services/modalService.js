// modalService: централізований сервіс для роботи з модальними вікнами.
...
/**
 * Підписка на стан модального вікна
 */
...
/**
 * Централізований API для роботи з модальними вікнами
 */
