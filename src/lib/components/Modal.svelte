...
<style>
  ...
  .volume-slider::-webkit-slider-runnable-track {
    ...
    background: linear-gradient(
      to right,
      var(--confirm-action-bg) var(--volume-percentage),
      #3a3f44 var(--volume-percentage)
    );
    border-radius: 7px;
  ...
  .volume-thumb-svg {
    ...
    filter: drop-shadow(0 0 0.8px #4caf50) drop-shadow(0 0 0.8px #4caf50)
      drop-shadow(0 0 0.8px #4caf50) drop-shadow(0 0 0.8px #4caf50);
  }
