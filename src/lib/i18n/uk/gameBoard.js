export default {
  ...
  scoreLabel: "Рахунок",
  cashOut: "Почати нову гру",
  cashOutTooltip: "Забрати бали та почати нову гру",
  cashOutLocal: "Достроково\nзавершити\nгру",
  tutorialTitle: "",
  tutorialContent: "Ваша мета — по черзі рухати спільну фігуру, не виходячи за межі дошки. Ховайте фігуру або дошку в налаштуваннях, щоб заробляти більше балів за кожен хід!",
  info: "Відповіді на поширені питання",
  details: "Детальніше",
