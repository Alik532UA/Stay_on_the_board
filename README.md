...
"Твій Хід" (Your Move) - це ігрова платформа, що пропонує різноманітні стратегічні настільні ігри. Поточна версія включає режим "Втримайся", де гравці намагаються утримати спільну фігуру на дошці якомога довше.
