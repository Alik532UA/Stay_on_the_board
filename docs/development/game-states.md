# Тип: Документація
# Статус: Актуально
# Назва: Стани гри та переходи
# Мета: Описати всі стани гри, їх елементи та переходи для розробників і тестувальників.
# Опис: Офіційний опис усіх станів гри Stay on the Board, їх елементів, переходів та логіки зміни стану. Містить приклади, схеми та підказки для розробників.
...
### 1а. Стан вибору режиму гри (Game Mode Selection State)
- **Опис**: Після натискання "Гра з VirtualPlayer" з'являється модальне вікно вибору режиму гри (GameModeModal)
- **Елементи**: Модальне вікно з вибором режиму (звичайний / заблоковані клітинки)
- **Доступні дії**: Вибрати режим або закрити модальне вікно
- **Після вибору режиму, вибраний режим має бути застосований у налаштуваннях гри (appSettingsStore) та підсвічуватися у блоці game-mode-row у меню налаштувань.**
- **Переходи**:
  - → Стан розміщення фігури (після вибору режиму)
  - → Головне меню (якщо модальне вікно закрито)
...
- **Елементи**: 
  ...
  - Білі точки показують доступні ходи (якщо увімкнено)
  - Підсвічені ходи показують вибраний напрямок/відстань
- **Доступні дії**: 
  - Вибір напрямку
  - Вибір відстані
  - Підтвердження ходу
  - Заява "Немає ходів"
  - Перемикання показу доступних ходів (через налаштування)
- **Переходи**: 
