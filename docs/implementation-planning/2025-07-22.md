### Завдання: Рефакторинг структури проєкту та очищення залежностей

**Мета:** Уніфікувати конфігурацію, видалити невикористовувані пакети та зайві файли, привести проєкт до стандартної структури SvelteKit.
