...
**Мета:** Повністю відновити функціональність та візуальний вигляд ігрового екрану після архітектурного рефакторингу на віджети. Цей план передбачає наповнення кожного нового компонента-віджета відповідною логікою, стилями та розміткою, щоб повернути грі очікуваний інтерактивний стан.
